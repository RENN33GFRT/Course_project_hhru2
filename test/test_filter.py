...
def sample_vacancies():
    return {
        "items": [
            ...
            {
                "name": "Java Developer",
                "snippet": {"requirement": "Java and Spring experience", "responsibility": "Backend development"},
            },
            {"name": "Frontend Developer", "snippet": {"requirement": "JavaScript, React", "responsibility": None}},
            {
                "name": "DevOps Engineer",
                "snippet": {"requirement": None, "responsibility": "Deploy and maintain infrastructure"},
            },
        ]
    }
...
def test_filter_with_none_requirements(sample_vacancies):
    ...
    sample_vacancies["items"].append(
        {"name": "Test Vacancy", "snippet": {"requirement": None, "responsibility": "Test responsibilities"}}
    )
...
def test_filter_with_empty_requirements_string(sample_vacancies):
    ...
    sample_vacancies["items"].append(
        {"name": "Empty Requirements", "snippet": {"requirement": "", "responsibility": "Some responsibilities"}}
    )
